...
@EnableJpaRepositories(
    ...
    basePackages = "com.richard.postgres.repositories"
)
public class PostgresDsConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        EntityManagerFactoryBuilder builder, @Qualifier("postgresSource") DataSource dataSource) {
        ...
        return builder.dataSource(dataSource)
                      ...
                      .packages("com.richard.postgres.domain")
